...
export function get_public_key(a: number, b: number): number;
...
export function get_verifying_key(a: number, b: number): number;
export function hex_to_b64(a: number, b: number): number;
